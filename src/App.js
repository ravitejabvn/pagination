...
class App extends Component {
  ...
  componentDidMount() {
    ...
    const url = 'https://my.api.mockaroo.com/users.json?key=cde45810';
    this.props.fetchData(url, offset, limit);
    // $.ajax({
    //   url,
    //   type: 'GET',
    //   dataType: "json",
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    fetchData: function (url, offset, limit) {
      actions.fetchData(dispatch, url, offset, limit);
    }
  }
}
